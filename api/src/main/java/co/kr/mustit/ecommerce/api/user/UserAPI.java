package co.kr.mustit.ecommerce.api.user;

import co.kr.mustit.ecommerce.api.APIName;
import co.kr.mustit.ecommerce.api.controller.AbstractBaseController;
import co.kr.mustit.ecommerce.api.request.model.AuthRequestModel;
import co.kr.mustit.ecommerce.api.request.model.UserChangePasswordModel;
import co.kr.mustit.ecommerce.api.request.model.UserListRequestModel;
import co.kr.mustit.ecommerce.api.request.model.UserRequestModel;
import co.kr.mustit.ecommerce.api.response.model.APIResponse;
import co.kr.mustit.ecommerce.api.response.model.PagingResponseModel;
import co.kr.mustit.ecommerce.api.response.model.UserDetailResponseModel;
...
import co.kr.mustit.ecommerce.service.UserAddressService;
import co.kr.mustit.ecommerce.service.UserService;
import co.kr.mustit.ecommerce.service.UserTokenService;
import co.kr.mustit.ecommerce.service.auth.AuthService;
import co.kr.mustit.util.Constant;
import co.kr.mustit.util.DateUtil;
import co.kr.mustit.util.MD5Hash;
...
public class UserAPI extends AbstractBaseController {
    ...
    public ResponseEntity<APIResponse> getUserList(
        ...
        try {
            ...
            org.springframework.data.domain.Page<User> users = userService.doFilterSearchSortPagingUser(userId, company_id, request.getSearchKey(), request.getSortCase(), request.getAscSort(), request.getPageSize(), request.getPageNumber());
